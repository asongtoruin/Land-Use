...
def classify_areas():
        ...
        #scenario = data[['pop_per_hectare', 'workers_per_hectare','scenario']]
        
        #full_data = pd.merge(full_data, scenario, on = ['msoa_zone_id','pop_per_hectare', 'workers_per_hectare'])
   #     full_data = pd.merge(full_data, y_km, on = )
         #  full_data2 = pd.merge(
        #    full_data,
         #   scenario, 
